...
Spring Boot依赖使用的groupId为`org.springframework.boot`。通常，你的Maven POM文件会继承`spring-boot-starter-parent`工程，并声明一个或多个[“Starter POMs”](https://github.com/cwiki-us-spring-guides/Spring-Boot-Reference-Guide/tree/0047aa8098a650dde0c93f4d2e91754c83468c4b/III.%20Using%20Spring%20Boot/13.4.%20Starter%20POMs.md)依赖。此外，Spring Boot提供了一个可选的[Maven插件](https://github.com/cwiki-us-spring-guides/Spring-Boot-Reference-Guide/tree/0047aa8098a650dde0c93f4d2e91754c83468c4b/VIII.%20Build%20tool%20plugins/58.%20Spring%20Boot%20Maven%20plugin.md)，用于创建可执行jars。
